...
def processed_text(text):
    ...
    # choice to not remove stop words as many of the stop words such as 
    # "not" are actually relevant for sentiment analysis and proved unhelpful
...
def get_polarity(review_number):
    ...
    # print the relevant text review, the cleaned data review, the polarity,
    # a predicted review score based on the polarity, and the actual review rating given
